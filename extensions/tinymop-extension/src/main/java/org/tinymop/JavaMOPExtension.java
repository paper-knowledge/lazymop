...
public class JavaMOPExtension extends AbstractEventSpy {
    ...
    private void updateJUnit(MavenProject project) {
        // There is a bug in JUnit 4.13 and 4.13.1 that prevents shutdown hooks from executing.
        // If the JUnit version is 4.13 or 4.13.1, we will change it to 4.13.2.
        // source: https://github.com/junit-team/junit4/issues/1652
        for (Dependency dependency : project.getDependencies()) {
            if (dependency.getGroupId().equals("junit") && dependency.getArtifactId().equals("junit")) {
                ...
                ComparableVersion junit4_13 = new ComparableVersion("4.13");
                ComparableVersion junit4_13_1 = new ComparableVersion("4.13.1");

                if (junitVersion.compareTo(junit4_13) == 0 || junitVersion.compareTo(junit4_13_1) == 0 ) {
                    System.out.println("Update JUnit version to 4.13.2");
